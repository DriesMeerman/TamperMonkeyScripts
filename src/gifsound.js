...
function main() {
    ...
    var config = {
    embedsubredditleft : "//www.reddit.com/r/WoahGifSound/hot/.embed?limit=10&t=all",
    embedsubredditright : "//www.reddit.com/r/musicgifstation/hot/.embed?limit=10&t=all"
};
    ...
    $.ajax(
		{
			url: config.embedsubredditright,
			type: 'GET',
			crossDomain: true,
			dataType: 'jsonp',
